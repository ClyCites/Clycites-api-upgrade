        ...
        properties: {
          ...
          reading: {
            ...
            properties: {
              ...
              weatherCode: { type: 'integer', minimum: 0 },
              isDay: { type: 'boolean' },
              vapourPressureDeficitKPa: { type: 'number', minimum: 0 },
              evapotranspirationMm: { type: 'number' },
              et0FaoEvapotranspirationMm: { type: 'number', minimum: 0 },
              shortwaveRadiationWm2: { type: 'number', minimum: 0 },
              directRadiationWm2: { type: 'number', minimum: 0 },
              diffuseRadiationWm2: { type: 'number', minimum: 0 },
              directNormalIrradianceWm2: { type: 'number', minimum: 0 },
              sunshineDurationSeconds: { type: 'number', minimum: 0 },
              soilTemperature0cm: { type: 'number' },
              soilTemperature6cm: { type: 'number' },
              soilMoisture0To1cm: { type: 'number', minimum: 0, maximum: 1 },
              soilMoisture1To3cm: { type: 'number', minimum: 0, maximum: 1 },
              soilMoisture3To9cm: { type: 'number', minimum: 0, maximum: 1 },
            },
          },
        },
      }),
