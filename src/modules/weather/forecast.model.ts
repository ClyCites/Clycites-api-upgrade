...
const forecastPredictionSchema = new Schema(
  {
    ...
    isDay:                        { type: Boolean, default: null },
    vapourPressureDeficitKPa:     { type: Number, default: null, min: 0 },
    evapotranspirationMm:         { type: Number, default: null },
    et0FaoEvapotranspirationMm:   { type: Number, default: null, min: 0 },
    shortwaveRadiationWm2:        { type: Number, default: null, min: 0 },
    shortwaveRadiationSumMjM2:    { type: Number, default: null, min: 0 },
    directRadiationWm2:           { type: Number, default: null, min: 0 },
    diffuseRadiationWm2:          { type: Number, default: null, min: 0 },
    directNormalIrradianceWm2:    { type: Number, default: null, min: 0 },
    sunshineDurationSeconds:      { type: Number, default: null, min: 0 },
    daylightDurationSeconds:      { type: Number, default: null, min: 0 },
    sunrise:                      { type: Date, default: null },
    sunset:                       { type: Date, default: null },
    soilTemperature0cm:           { type: Number, default: null },
    soilTemperature6cm:           { type: Number, default: null },
    soilMoisture0To1cm:           { type: Number, default: null, min: 0, max: 1 },
    soilMoisture1To3cm:           { type: Number, default: null, min: 0, max: 1 },
    soilMoisture3To9cm:           { type: Number, default: null, min: 0, max: 1 },
  },
  { _id: false }
);
